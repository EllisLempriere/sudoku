...
{
    public class NakedDoubleStep : ClearingSolverStep
    {
        /// <summary>
        /// Type of the region containing the naked double
        /// </summary>
        public RegionType PrimaryRegionType { get; set; }

        /// <summary>
        /// Region Number of the region containing the naked double
        /// </summary>
        public int PrimaryRegionNumber { get; set; }

        /// <summary>
        /// Co-ordinates of the two region cells constraining the naked double
        /// </summary>
        ...
        {
            var step = obj as NakedDoubleStep;
